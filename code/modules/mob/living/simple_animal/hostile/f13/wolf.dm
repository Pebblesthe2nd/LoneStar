...
/mob/living/simple_animal/hostile/wolf
	...
	environment_smash = 0
	guaranteed_butcher_results = list(/obj/item/stack/sheet/animalhide/dog = 1, /obj/item/reagent_containers/food/snacks/meat/slab/wolf = 1,/obj/item/stack/sheet/bone = 1)
...
/mob/living/simple_animal/hostile/wolf/alpha
	...
	guaranteed_butcher_results = list(/obj/item/stack/sheet/animalhide/dog = 1, /obj/item/reagent_containers/food/snacks/meat/slab/wolf = 3,/obj/item/stack/sheet/bone = 2)
	maxHealth = 100
	health = 100
...
/mob/living/simple_animal/hostile/wolf/cold
	...
	icon_living = "wolf"
	icon_dead = "wolf_dead"
	guaranteed_butcher_results = list(/obj/item/stack/sheet/animalhide/raw_wolfpelt = 1, /obj/item/reagent_containers/food/snacks/meat/slab/wolf = 3,/obj/item/stack/sheet/bone = 2)
	maxHealth = 100
	health = 100
	melee_damage_lower = 25
	melee_damage_upper = 35
